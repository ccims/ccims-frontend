  ...
  template: `
    <app-timeline-item [timelineItem]="timelineItem">
      <ng-template appSingleTimelineItem>
        ...
        <app-issue-item [issue]="event.removedLinkedIssue" [interactive]="true" [projectId]="projectID"> </app-issue-item>
      </ng-template>
      <ng-template appCoalescedTimelineItems>
        <a>{{ timelineItem.user }}</a> removed links to issues
        <ng-container *ngFor="let item of events">
          <app-issue-item [issue]="item.removedLinkedIssue" [interactive]="true" [projectId]="projectID"> </app-issue-item>
        </ng-container>
      </ng-template>
    </app-timeline-item>
  `
