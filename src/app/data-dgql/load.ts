...
const nodeQueries: NodeQueries = {
  [NodeType.Project]: (i, id) =>
    i.q.projects.getProject(id).then((data) => data.node),
  [NodeType.Component]: (i, id) =>
    i.q.components.getComponent(id).then((data) => data.node),
  [NodeType.ComponentInterface]: (i, id) =>
    i.q.components.getInterface(id).then((data) => data.node),
  [NodeType.Issue]: (i, id) =>
    i.q.issues.getIssueHeader(id).then((data) => data.node),
  [NodeType.User]: (i, id) =>
    id === CURRENT_USER_NODE.id
      ? i.q.users.currentUser().then((data) => data.currentUser)
      : Promise.reject(new Error('not implemented')),
  [NodeType.Label]: (i, id) =>
    i.q.issues.getLabel(id).then((data) => data.node),
};
...
const listQueries: ListQueries = {
  ...
  [ListType.Components]: {
    [NodeType.Project]: (i, list, params) =>
      i.q.components
        .listProjectComponents(list.node.id, listParams(params))
        .then((data) => ({
    ...
    [NodeType.Issue]: (i, list, params) =>
      i.q.issues
        .listIssueComponents(list.node.id, listParams(params))
        .then((data) => ({
          totalCount: data.node.components.totalCount,
          pageInfo: data.node.components.pageInfo,
          items: i.c.insertNodes(data.node.components.nodes),
    ...
    [NodeType.Label]: (i, list, params) =>
      i.q.issues
        .listLabelComponents(list.node.id, listParams(params))
        .then((data) => ({
          totalCount: data.node.components.totalCount,
          pageInfo: data.node.components.pageInfo,
          items: i.c.insertNodes(data.node.components.nodes),
  ...
  [ListType.ComponentInterfaces]: {
    [NodeType.Project]: (i, list, params) =>
      i.q.components
        .listProjectInterfaces(list.node.id, listParams(params))
        .then((data) => ({
  ...
  [ListType.Issues]: {
    [NodeType.Project]: (i, list, params) =>
      i.q.issues
        .listProjectIssues(list.node.id, listParams(params))
        .then((data) => ({
    ...
    [NodeType.Component]: (i, list, params) =>
      i.q.issues
        .listComponentIssues(list.node.id, listParams(params))
        .then((data) => ({
          totalCount: data.node.issues.totalCount,
          pageInfo: data.node.issues.pageInfo,
          items: i.c.insertNodes(data.node.issues.nodes),
  ...
  [ListType.IssuesOnLocation]: {
    [NodeType.Component]: (i, list, params) =>
      i.q.issues
        .listComponentIssuesOnLocation(list.node.id, listParams(params))
        .then((data) => ({
  ...
  [ListType.TimelineItems]: {
    [NodeType.Issue]: (i, list, params) =>
      i.q.issues
        .listIssueTimelineItems(list.node.id, listParams(params))
        .then((data) => ({
  ...
  [ListType.IssueLocations]: {
    [NodeType.Issue]: (i, list, params) =>
      i.q.issues
        .listIssueLocations(list.node.id, listParams(params))
        .then((data) => ({
  ...
  [ListType.Labels]: {
    [NodeType.Project]: (i, list, params) =>
      i.q.issues
        .listProjectLabels(list.node.id, listParams(params))
        .then((data) => ({
    ...
    [NodeType.Component]: (i, list, params) =>
      i.q.issues
        .listComponentLabels(list.node.id, listParams(params))
        .then((data) => ({
          totalCount: data.node.labels.totalCount,
          pageInfo: data.node.labels.pageInfo,
          items: i.c.insertNodes(data.node.labels.nodes),
    ...
    [NodeType.Issue]: (i, list, params) =>
      i.q.issues
        .listIssueLabels(list.node.id, listParams(params))
        .then((data) => ({
          totalCount: data.node.labels.totalCount,
          pageInfo: data.node.labels.pageInfo,
          items: i.c.insertNodes(data.node.labels.nodes),
  ...
  [ListType.Assignees]: {
    [NodeType.Issue]: (i, list, params) =>
      i.q.issues
        .listIssueAssignees(list.node.id, listParams(params))
        .then((data) => ({
  ...
  [ListType.LinkedIssues]: {
    [NodeType.Issue]: (i, list, params) =>
      i.q.issues
        .listIssueLinksToIssues(list.node.id, listParams(params))
        .then((data) => ({
  ...
  [ListType.LinkedByIssues]: {
    [NodeType.Issue]: (i, list, params) =>
      i.q.issues
        .listIssueLinkedByIssues(list.node.id, listParams(params))
        .then((data) => ({
  ...
  [ListType.SearchUsers]: {
    [NodeType.Root]: (i, list, params) =>
      i.q.users
        .searchUsers(params.filter as { username: string })
        .then((data) => ({
...
export const queryList =
  ...
  async <T, F>(
    ...
    const i = { q, c };
    return (await listQueries[type][node.type](
      i,
      { node, type },
      params
    )) as ListResult<T>;
